...
cloudant_username = '297041f9-46b2-45fa-95fc-3aa89b5657d0-bluemix'
cloudant_api_key = 'HrQwxh5OnQW-ijGKvyTeNtsj8SJDr__MMJthko-UPSnO'
cloudant_url = 'https://297041f9-46b2-45fa-95fc-3aa89b5657d0-bluemix.cloudantnosqldb.appdomain.cloud'
...
def post_review():
    ...
    required_fields = ['id','time',  'name', 'dealership', 'review', 'purchase', 'purchase_date', 'car_make', 'car_model', 'car_year']
